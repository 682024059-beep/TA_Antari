/* ============================================================
   ANTARI — DataService
   Lapisan tipis di atas Api (js/api.js). Semua fungsi di sini
   bersifat ASYNC (mengembalikan Promise) karena data sekarang
   benar-benar diambil dari server (TiDB), bukan localStorage.
   Setiap pemanggil WAJIB pakai await / .then().
   ============================================================ */
...
const DataService = {
  ...
  /* ---------------- Notifikasi ---------------- */
  async getNotifikasi(){ return Api.getNotifikasi(); }, // { notifikasi, unread }
